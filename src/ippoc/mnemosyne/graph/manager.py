    ...
    async def find_similar_entities(
        ...
        try:
            async with self.Session() as session:
                ...
                # Optimization: Replaced N+1 query loop and Python Jaccard calculation with a single SQL query using CTEs for intersection and candidate totals to avoid full table scans of unrelated entities.
