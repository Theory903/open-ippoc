    ...
    async def find_similar_entities(
        ...
        try:
            async with self.Session() as session:
                ...
                # Optimization: Replace N+1 query looping over all entities with a single SQL query using CTEs.
                # This calculates the Jaccard similarity directly in SQL, filtering candidates early.
                stmt = text("""
                    WITH ref_rels AS (
