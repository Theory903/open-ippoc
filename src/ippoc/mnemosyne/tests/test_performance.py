...
sys.modules["ippoc.mnemosyne.episodic"] = MagicMock()
sys.modules["mnemosyne.episodic.manager"] = MagicMock()
sys.modules["ippoc.mnemosyne.episodic.manager"] = MagicMock()
sys.modules["mnemosyne.procedural"] = MagicMock()
sys.modules["ippoc.mnemosyne.procedural"] = MagicMock()
sys.modules["mnemosyne.procedural.manager"] = MagicMock()
sys.modules["ippoc.mnemosyne.procedural.manager"] = MagicMock()
sys.modules["mnemosyne.hidb"] = MagicMock()
sys.modules["ippoc.mnemosyne.hidb"] = MagicMock()
...
try:
    ...
    # Fallback if ippoc package structure is different in test env
