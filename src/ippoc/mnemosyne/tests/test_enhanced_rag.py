...
async def test_adaptive_router():
    ...
    try:
        from ippoc.cortex.gateway.router import get_adaptive_router, RAGType
    ...
    try:
        ...
        class MockSemanticManager:
            ...
            async def add_memory(self, content, metadata=None, content_type=None):
                from ippoc.mnemosyne.semantic.rag import SemanticObject, ContentType
                import hashlib
        ...
        from ippoc.mnemosyne.semantic.rag import ContentType
...
async def test_procedural_enhancements():
    ...
    try:
        ...
        from ippoc.mnemosyne.procedural.manager import ProceduralManager
...
async def test_semantic_enhancements():
    ...
    try:
        ...
        from ippoc.mnemosyne.semantic.rag import SemanticManager, ContentType
