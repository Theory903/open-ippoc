...
import pytest
from ippoc.cortex.maintainer.types import SignalSummary, PainScore, MentorAdvice
from ippoc.cortex.maintainer.pain import score_pain
from ippoc.cortex.maintainer.evolution_loop import maybe_evolve
...
def test_maintainer_decision_making():
    ...
    def mock_invoke(envelope):
        ...
        from ippoc.cortex.core.tools.base import ToolResult
