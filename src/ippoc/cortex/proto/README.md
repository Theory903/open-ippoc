...
```bash
# From the project root
python3 src/ippoc/cortex/proto/test_two_tower.py
```

### Service Integration Test (Requires running service)
```bash
# From the project root
python3 src/ippoc/cortex/proto/test_two_tower_service.py
```

### Client Library Test
```bash
# From the project root
python3 src/ippoc/cortex/proto/test_two_tower_client.py
```

### Quick Test (Check service availability)
```bash
# From the project root
python3 src/ippoc/cortex/proto/test_two_tower_client.py --quick
```
