...
Also categorize it into: research, technical, memory, factual, conversational, system, general"""),
    ...
    # Performance Optimization: Hoisted keyword lists to class-level immutable tuples
    # to avoid list allocation overhead during high-frequency intent classification.
    ...
    def _assess_complexity(self, query: str) -> float:
        ...
        # Performance Optimization: Unrolled generator expressions into explicit for-loops
        # to avoid generator object instantiation and execution overhead on every call.
