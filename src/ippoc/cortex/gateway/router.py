...
Also categorize it into: research, technical, memory, factual, conversational, system, general"""),
    ...
    # Static keywords for routing functions to optimize matching overhead
    ...
    _RESEARCH_INTENTS = ('research', 'study', 'analyze', 'investigate')
    _TECHNICAL_INTENTS = ('code', 'implement', 'program', 'script', 'function')
    _MEMORY_INTENTS = ('remember', 'recall', 'who', 'what', 'when', 'relationship')
    _FACTUAL_INTENTS = ('what is', 'how to', 'define', 'explain')
    _CONVERSATIONAL_INTENTS = ('hello', 'hi', 'hey', 'goodbye', 'thanks')
    _SYSTEM_INTENTS = ('status', 'version', 'ping', 'health', 'running')
