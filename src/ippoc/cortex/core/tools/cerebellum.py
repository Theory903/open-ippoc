...
class CerebellumAdapter(IPPOC_Tool):
    ...
    def __init__(self):
        ...
        # Go up 5 levels to reach project root: tools/ -> core/ -> cortex/ -> ippoc/ -> src/ -> root/
        repo_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../../../"))
        debug_path = os.path.join(repo_root, "src/ippoc/soma/target/debug/ippoc-node")
        release_path = os.path.join(repo_root, "src/ippoc/soma/target/release/ippoc-node")
