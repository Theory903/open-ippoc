...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        # Optimization: Manual dict construction is ~5x faster than dataclasses.asdict for deep copies
        data = {
            ...
            "tool_stats": {k: dict(v) for k, v in self.state.tool_stats.items()},
            "events": [dict(e) for e in self.state.events],
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manual dict construction is faster than dataclasses.asdict
