...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        # Optimization: Manually construct dictionary and shallow copy to avoid slow deep-copy overhead of dataclasses.asdict
        data = {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manually construct dict instead of using dataclass.asdict
    ...
    def snapshot(self) -> Dict[str, Any]:
        self.tick()
        # Optimization: Manually construct dictionary instead of using dataclasses.asdict
        data = {
            "budget": self.state.budget,
            "reserve": self.state.reserve,
            "total_spent": self.state.total_spent,
