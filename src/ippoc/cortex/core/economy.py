...
class EconomyState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        # Optimization: Manual dictionary construction with shallow copies avoids dataclasses.asdict deep-copy overhead
        return {
            "budget": self.budget,
            ...
            "tool_stats": {k: v.copy() for k, v in self.tool_stats.items()},
...
class EconomyManager:
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manual dict construction avoids dataclasses.asdict deepcopy
