...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        """
        # Optimization: Avoid deep-copy overhead of dataclasses.asdict
        # Manual dict construction is significantly faster for this nested structure
        data = {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Avoid dataclasses.asdict overhead on frequent updates
    ...
    def snapshot(self) -> Dict[str, Any]:
        self.tick()
        # Optimization: Manual copy to avoid asdict deep-copy performance hit
        data = {
            "budget": self.state.budget,
            "reserve": self.state.reserve,
            "total_spent": self.state.total_spent,
