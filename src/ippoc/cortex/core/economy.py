...
class EconomyManager:
    ...
    def _state_to_dict(self) -> Dict[str, Any]:
        # Optimization: Manual dict construction with shallow copies avoids dataclasses.asdict deep-copy overhead (~5ms per call)
        return {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manual dict construction avoids dataclasses.asdict deep-copy overhead
