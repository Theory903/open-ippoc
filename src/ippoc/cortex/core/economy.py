...
class EconomyManager:
    ...
    def _state_to_dict(self) -> dict:
        # Optimization: Manual serialization avoids dataclasses.asdict deep-copy overhead
        return {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Avoid dataclasses.asdict overhead
        self.state.tool_stats[tool_name] = stats.__dict__.copy()
