...
class EconomyManager:
    ...
    # Optimization: Manual dict creation instead of dataclasses.asdict
    # asdict is a significant performance bottleneck (adds ~5ms per call) when used frequently in tight loops like orchestrator invokes.
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manual dict creation to avoid slow dataclasses.asdict
