...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        # Optimization: Replaced dataclasses.asdict with manual dictionary construction
        # to avoid deep-copy overhead in high-frequency path (~5ms -> ~0.1ms).
        data = {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Use manual dict construction instead of asdict for ToolStats
