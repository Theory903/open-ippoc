...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        """
        # Optimization: Manually construct dictionary and use shallow copy for nested structures
        # to avoid deep-copy overhead of dataclasses.asdict (~5ms -> ~0.1ms per call)
        data = {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manually map fields to avoid dataclasses.asdict overhead
    ...
    def snapshot(self) -> Dict[str, Any]:
        self.tick()
        # Optimization: Manually construct dictionary and use shallow copy for nested structures
        # to avoid deep-copy overhead of dataclasses.asdict
        data = {
            "budget": self.state.budget,
            "reserve": self.state.reserve,
            "total_spent": self.state.total_spent,
