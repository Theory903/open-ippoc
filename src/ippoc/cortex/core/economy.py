...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        # Optimization: Manually construct dict instead of slow dataclasses.asdict (~30x faster)
        data = {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manually construct dict instead of slow dataclasses.asdict
