...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        # Optimization: Manual dictionary construction instead of dataclasses.asdict()
        # asdict() does a deepcopy which takes ~5ms for nested structures with many events/tools.
        # This manual mapping is ~20x faster.
        data = {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manual dict to avoid deepcopy overhead of asdict()
