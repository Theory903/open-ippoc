...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        """
        # Optimization: Avoid dataclasses.asdict due to deep-copy overhead. Manually construct dictionary and use shallow .copy() for nested structures
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Avoid dataclasses.asdict
