...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        # Optimization: Manual serialization avoids deepcopy overhead of dataclasses.asdict (~100x faster)
        data = {
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: Manual serialization avoids deepcopy overhead of dataclasses.asdict
