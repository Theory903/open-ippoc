...
export class ToolSmith {
     ...
     */
    extractToolInfo(readme, repoUrl, metadata) {
        ...
        const matches = Array.from(readme.matchAll(codeBlockRegex));
     ...
     */
    async createSkill(name, pathStr, resources = []) {
        ...
        try {
            ...
            console.log(`[ToolSmith] Executing: python3 ${args.join(" ")}`);
