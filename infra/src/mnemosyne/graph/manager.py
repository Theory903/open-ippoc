    ...
    async def find_similar_entities(
        ...
        try:
            async with self.Session() as session:
                ...
                # Optimization: Intersection-first query using CTEs for Jaccard similarity to avoid N+1 queries
                ...
                # Optimization: Identify candidates and count intersection/totals directly in SQL
                stmt = text("""
                    WITH ref_rels AS (
