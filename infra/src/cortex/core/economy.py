...
class EconomyManager:
    ...
    def _save(self) -> None:
        ...
        with open(self.path, "w", encoding="utf-8") as f:
            ...
            data = {
                ...
                "events": [
                    e.copy() if isinstance(e, dict) else e for e in self.state.events
                ],
    ...
    def update_tool_stats(self, tool_name: str, stats: ToolStats) -> None:
        # Optimization: asdict is slow. Use manual dict creation.
    ...
    def snapshot(self) -> Dict[str, Any]:
        self.tick()
        # Optimization: dataclasses.asdict is deep-copying and slow.
        # We manually structure the dictionary instead for a massive speedup.
        data = {
            "budget": self.state.budget,
            "reserve": self.state.reserve,
            "total_spent": self.state.total_spent,
