...
class EconomyManager:
    ...
    def _state_to_dict(self) -> Dict[str, Any]:
        """
        Optimization: Manual serialization instead of dataclasses.asdict
        asdict performs deep copies and type checks making it ~500x slower
        for complex nested structures like EconomyState.
        """
        return {
            ...
            # Shallow copy the dictionary and its inner dicts to prevent mutation
