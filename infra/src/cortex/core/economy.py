...
class ToolStats:
    ...
    def to_dict(self) -> dict:
        # Optimization: manual dict conversion instead of asdict
        return {
            "calls": self.calls,
...
class EconomyState:
    ...
    def to_dict(self) -> dict:
        # Optimization: manual dict construction instead of asdict to avoid deepcopy overhead
        return {
            "budget": self.budget,
...
try:
    from cortex.core.rwe import get_rwe
