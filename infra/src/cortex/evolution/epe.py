...
class CanonScanner:
    ...
    # Performance Optimization: Compile regexes once at the class level instead of inside __init__.
    # Instantiation benchmarking showed ~15x speedup (0.0580s -> 0.0039s per 10000 instantiations).
    _FORBIDDEN_PATTERNS = [
        # Identity violations
