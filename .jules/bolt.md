...
## 2024-05-29 - SQL CTEs vs Python loops for Graph Similarity
**Learning:** Using Python loops to fetch relations for 1000s of entities iteratively causes N+1 query bottlenecks and slow performance (1.03s vs 0.02s).
**Action:** Push complex operations like intersection, union, and Jaccard similarity directly into the SQL engine using CTEs.
