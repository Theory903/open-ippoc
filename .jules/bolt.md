...
## 2026-05-29 - SQL Join Optimization over N+1 Queries
**Learning:** Performing iterative database queries (N+1) to fetch relationships and doing Python-side Jaccard similarity comparison is extremely slow.
**Action:** Push data processing and comparison down to the database using CTEs and JOINs, especially when computing similarities, to significantly reduce I/O overhead and improve speed.
