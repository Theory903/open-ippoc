...
## 2026-05-29 - Optimize Graph Path Finding N+1 Queries
**Learning:** Python-level graph traversal with lazy loading leads to N+1 query problems in deep or branched graphs.
**Action:** Replaced BFS with recursive database-level Common Table Expressions (CTE) and bulk fetching for significant speedups.
