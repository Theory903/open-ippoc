...
## 2026-05-29 - CTE-based Similarity Search Optimization
**Learning:** N+1 queries in graph relation intersection comparisons (Jaccard similarity) create massive overhead when comparing against all entities.
**Action:** Use CTEs in SQL to compute intersection candidates and calculate similarity directly within the database instead of pulling all rows into Python memory.
