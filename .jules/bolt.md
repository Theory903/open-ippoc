...
## 2025-03-05 - Entity Similarity Search Optimization
**Learning:** Using iterative SQL queries and python loop for knowledge graph entity similarity calculation forces a full table scan and triggers the N+1 problem.
**Action:** Implement Common Table Expressions (CTEs) within a single SQL statement to calculate intersection-first candidates and calculate the Jaccard similarity directly within the database engine.
