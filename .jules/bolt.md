...
## 2026-05-29 - SQL CTE Jaccard Optimization
**Learning:** N+1 Python iteration logic when calculating Jaccard similarities over large datasets can be excessively slow (~1.5s vs ~0.01s).
**Action:** Use SQL Common Table Expressions (CTEs) to isolate intersection bounds, bulk count, and mathematically return the similarity threshold directly from the SQL engine.
