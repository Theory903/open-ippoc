...
## 2026-03-10 - [Jaccard Similarity Performance Fix]
**Learning:** For N+1 query patterns traversing all graph entities to compute Jaccard similarity, employing an intersection-first recursive CTE pattern is a major optimization.
**Action:** Use SQL joins and CTEs instead of executing N secondary queries for computing complex set metrics over relations.
